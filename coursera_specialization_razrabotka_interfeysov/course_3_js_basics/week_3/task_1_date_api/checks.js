...
assert.deepEqual(
  ...
  'Дата "2015-01-01 00:00" после операций "[["add",5,"minutes"],["add",1,"hours"],["add",2,"days"],["add",3,"months"],["add",1,"years"]]" должна стать "2016-04-03 01:05"'
);
